...
mtypes = ['Abstraction', 'Water Level', 'Flow', 'Temperature', 'Precipitation', 'Nitrate Nitrogen', 'Nitrate-N + Nitrite-N', 'Ammoniacal Nitrogen', 'Total Nitrogen', 'Dissolved Oxygen', 'Dissolved Oxygen % Saturation', 'Turbidity', 'Dissolved Reactive Phosphorus', 'Total Phosphorus', 'E. coli', 'Total Coliforms', 'Water Temperature (Field)', 'Conductivity (Field)', 'Conductivity', 'Total Suspended Solids', 'Chlorophyll a (planktonic)', 'Iron, Dissolved', 'Manganese, Dissolved', 'Arsenic, Dissolved']
